...
/*Fim Função Menu_Princ 1*/


/*Função Menu para a escolha de Espaços 2*/
char Menu_Espacos()
{
    char i;
    puts("  **** MENU ESPACOS ****\n");
...
/*Fim Função Menu_Espaços 2*/


/*Função Menu para a escolha do ficheiro Populaçao  3*/
char Menu_Pop()
{
    char i;
...
/*Fim Função Menu_Pop 3*/


/*Função Menu para a Interações  4*/
char Menu_Interacao()
{
    char i;
